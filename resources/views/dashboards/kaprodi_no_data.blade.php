...
<head>
    ...
    <title>Jurusan Belum Diatur</title>
...
<body class="bg-slate-50 h-screen w-full flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center relative overflow-hidden">
        ...
        <div class="mx-auto w-20 h-20 bg-orange-50 text-orange-500 rounded-full flex items-center justify-center mb-6 animate-pulse-slow">
        ...
        <h1 class="text-2xl font-bold text-slate-800 mb-2">Jurusan Belum Diatur</h1>
        ...
        <div class="text-slate-500 text-sm mb-6 leading-relaxed">
            ...
            <p>
                Sistem mendeteksi Anda sebagai <strong>Kaprodi</strong>, namun belum ada data <strong>Jurusan</strong> yang dihubungkan dengan akun Anda.
            </p>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8 text-left flex items-start gap-3">
            ...
            <div class="text-xs text-blue-800">
                ...
                Silakan hubungi <span class="font-bold">Operator Sekolah</span> atau <span class="font-bold">Waka Kurikulum</span> untuk melakukan <em>mapping</em> (penautan) jurusan yang Anda ampu.
            </div>
        </div>
